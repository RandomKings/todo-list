...
def get_task_by_id(task_id: int):  # Corrected typing to int
    if task_id in tasks:
...
def delete_task_by_id(task_id: int):  # Corrected typing to int
    if task_id in tasks:
        del tasks[task_id]
...
def update_task(task_id: int, updated_task: Task):  # Corrected typing to int
    if task_id in tasks:
